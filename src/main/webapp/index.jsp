...
<div class="formBox">
    <h2 style="text-align: center;margin-bottom: 20px ">509购物站</h2>
    <form action = "loginDeal.jsp" method = "post">
        ...
        <div class="form-group formButton">
            <button type="submit" class="fcButton2">登录</button>
            <a href="signUpPage.jsp"><button type="button" class="fcButton">注册</button></a>
        </div>
